...
stds.roblox = {
    ...
    read_globals = {
        ...
        Axes = def_fields{"new"};
        BrickColor = def_fields{"Blue", "White", "Yellow", "Red", "Gray", "palette", "New", "Black", "Green", "Random", "DarkGray", "random", "new"};
        CellId = def_fields{"new"};
        CFrame = def_fields{"fromMatrix", "fromAxisAngle", "fromOrientation", "fromEulerAnglesXYZ", "Angles", "fromEulerAnglesYXZ", "new"};
        Color3 = def_fields{"fromHSV", "toHSV", "fromRGB", "new"};
        ColorSequence = def_fields{"new"};
        ColorSequenceKeypoint = def_fields{"new"};
        DateTime = def_fields{"fromIsoDate", "fromUnixTimestamp", "now", "new"};
        ...
        PathWaypoint = def_fields{"new"};
        PhysicalProperties = def_fields{"new"};
        PluginDrag = def_fields{"new"};
        ...
        UDim = def_fields{"new"};
        UDim2 = def_fields{"fromOffset", "fromScale", "new"};
        Vector2 = def_fields{"new"};
        Vector2int16 = def_fields{"new"};
        Vector3 = def_fields{"FromNormalId", "FromAxis", "new"};
        Vector3int16 = def_fields{"new"};
        bit32 = def_fields{"band", "extract", "bor", "bnot", "arshift", "rshift", "rrotate", "replace", "lshift", "lrotate", "btest", "bxor"};
        coroutine = def_fields{"resume", "yield", "running", "status", "wrap", "create", "isyieldable"};
        debug = def_fields{"traceback", "profileend", "profilebegin"};
        math = def_fields{"log", "ldexp", "rad", "cosh", "random", "frexp", "tanh", "floor", "max", "sqrt", "modf", "huge", "pow", "atan", "tan", "cos", "sign", "clamp", "log10", "noise", "acos", "abs", "pi", "sinh", "asin", "min", "deg", "fmod", "randomseed", "atan2", "ceil", "sin", "exp"};
        os = def_fields{"difftime", "time", "date"};
        string = def_fields{"sub", "split", "upper", "len", "find", "match", "char", "rep", "gmatch", "reverse", "byte", "format", "gsub", "lower"};
        table = def_fields{"pack", "move", "insert", "getn", "foreachi", "maxn", "foreach", "concat", "unpack", "find", "create", "sort", "remove"};
        utf8 = def_fields{"offset", "codepoint", "nfdnormalize", "char", "codes", "len", "graphemes", "nfcnormalize", "charpattern"};
        ...
        Enum = {
            ...
            fields = {
                ...
                BodyPartR15 = def_enum{"Head", "UpperTorso", "LowerTorso", "LeftFoot", "LeftLowerLeg", "LeftUpperLeg", "RightFoot", "RightLowerLeg", "RightUpperLeg", "LeftHand", "LeftLowerArm", "LeftUpperArm", "RightHand", "RightLowerArm", "RightUpperArm", "RootPart", "Unknown"};
                ...
                ButtonStyle = def_enum{"Custom", "RobloxButtonDefault", "RobloxButton", "RobloxRoundButton", "RobloxRoundDefaultButton", "RobloxRoundDropdownButton"};
                CameraMode = def_enum{"Classic", "LockFirstPerson"};
                CameraPanMode = def_enum{"Classic", "EdgeBump"};
                CameraType = def_enum{"Fixed", "Watch", "Attach", "Track", "Follow", "Custom", "Scriptable", "Orbital"};
                CellBlock = def_enum{"Solid", "VerticalWedge", "CornerWedge", "InverseCornerWedge", "HorizontalWedge"};
                CellMaterial = def_enum{"Empty", "Grass", "Sand", "Brick", "Granite", "Asphalt", "Iron", "Aluminum", "Gold", "WoodPlank", "WoodLog", "Gravel", "CinderBlock", "MossyStone", "Cement", "RedPlastic", "BluePlastic", "Water"};
                CellOrientation = def_enum{"NegZ", "X", "Z", "NegX"};
                CenterDialogType = def_enum{"UnsolicitedDialog", "PlayerInitiatedDialog", "ModalDialog", "QuitDialog"};
                ChatCallbackType = def_enum{"OnCreatingChatWindow", "OnClientSendingMessage", "OnClientFormattingMessage", "OnServerReceivingMessage"};
                ...
                CoreGuiType = def_enum{"PlayerList", "Health", "Backpack", "Chat", "All", "EmotesMenu"};
                CreatorType = def_enum{"User", "Group"};
                CurrencyType = def_enum{"Default", "Robux", "Tix"};
                CustomCameraMode = def_enum{"Default", "Follow", "Classic"};
                DataStoreRequestType = def_enum{"GetAsync", "SetIncrementAsync", "UpdateAsync", "GetSortedAsync", "SetIncrementSortedAsync", "OnUpdate"};
                DateTimeKind = def_enum{"Utc", "Local"};
                DevCameraOcclusionMode = def_enum{"Zoom", "Invisicam"};
                DevComputerCameraMovementMode = def_enum{"UserChoice", "Classic", "Follow", "Orbital"};
                DevComputerMovementMode = def_enum{"UserChoice", "KeyboardMouse", "ClickToMove", "Scriptable"};
                DevTouchCameraMovementMode = def_enum{"UserChoice", "Classic", "Follow", "Orbital"};
                DevTouchMovementMode = def_enum{"UserChoice", "Thumbstick", "DPad", "Thumbpad", "ClickToMove", "Scriptable", "DynamicThumbstick"};
                DeveloperMemoryTag = def_enum{"Internal", "HttpCache", "Instances", "Signals", "LuaHeap", "Script", "PhysicsCollision", "PhysicsParts", "GraphicsSolidModels", "GraphicsMeshParts", "GraphicsParticles", "GraphicsParts", "GraphicsSpatialHash", "GraphicsTerrain", "GraphicsTexture", "GraphicsTextureCharacter", "Sounds", "StreamingSounds", "TerrainVoxels", "Gui", "Animation", "Navigation"};
                ...
                EasingStyle = def_enum{"Linear", "Sine", "Back", "Quad", "Quart", "Quint", "Bounce", "Elastic", "Exponential", "Circular", "Cubic"};
                ElasticBehavior = def_enum{"WhenScrollable", "Always", "Never"};
                EnviromentalPhysicsThrottle = def_enum{"DefaultAuto", "Disabled", "Always", "Skip2", "Skip4", "Skip8", "Skip16"};
                ...
                Font = def_enum{"Legacy", "Arial", "ArialBold", "SourceSans", "SourceSansBold", "SourceSansSemibold", "SourceSansLight", "SourceSansItalic", "Bodoni", "Garamond", "Cartoon", "Code", "Highway", "SciFi", "Arcade", "Fantasy", "Antique", "Gotham", "GothamSemibold", "GothamBold", "GothamBlack"};
                FontSize = def_enum{"Size8", "Size9", "Size10", "Size11", "Size12", "Size14", "Size18", "Size24", "Size36", "Size48", "Size28", "Size32", "Size42", "Size60", "Size96"};
                FormFactor = def_enum{"Symmetric", "Brick", "Plate", "Custom"};
                FrameStyle = def_enum{"Custom", "ChatBlue", "RobloxSquare", "RobloxRound", "ChatGreen", "ChatRed", "DropShadow"};
                FramerateManagerMode = def_enum{"Automatic", "On", "Off"};
                FriendRequestEvent = def_enum{"Issue", "Revoke", "Accept", "Deny"};
                FriendStatus = def_enum{"Unknown", "NotFriend", "Friend", "FriendRequestSent", "FriendRequestReceived"};
                ...
                GearType = def_enum{"MeleeWeapons", "RangedWeapons", "Explosives", "PowerUps", "NavigationEnhancers", "MusicalInstruments", "SocialItems", "BuildingTools", "Transport"};
                Genre = def_enum{"All", "TownAndCity", "Fantasy", "SciFi", "Ninja", "Scary", "Pirate", "Adventure", "Sports", "Funny", "WildWest", "War", "SkatePark", "Tutorial"};
                GraphicsMode = def_enum{"Automatic", "Direct3D9", "Direct3D11", "OpenGL", "Metal", "Vulkan", "NoGraphics"};
                ...
                HttpCachePolicy = def_enum{"None", "Full", "DataOnly", "Default", "InternalRedirectRefresh"};
                HttpContentType = def_enum{"ApplicationJson", "ApplicationXml", "ApplicationUrlEncoded", "TextPlain", "TextXml"};
                HttpError = def_enum{"OK", "InvalidUrl", "DnsResolve", "ConnectFail", "OutOfMemory", "TimedOut", "TooManyRedirects", "InvalidRedirect", "NetFail", "Aborted", "SslConnectFail", "Unknown"};
                HttpRequestType = def_enum{"Default", "MarketplaceService", "Players", "Chat", "Avatar", "Analytics", "Localization"};
                HumanoidCollisionType = def_enum{"OuterBox", "InnerBox"};
                HumanoidDisplayDistanceType = def_enum{"Viewer", "Subject", "None"};
                HumanoidHealthDisplayType = def_enum{"DisplayWhenDamaged", "AlwaysOn", "AlwaysOff"};
                HumanoidRigType = def_enum{"R6", "R15"};
                HumanoidStateType = def_enum{"FallingDown", "Running", "RunningNoPhysics", "Climbing", "StrafingNoPhysics", "Ragdoll", "GettingUp", "Jumping", "Landed", "Flying", "Freefall", "Seated", "PlatformStanding", "Dead", "Swimming", "Physics", "None"};
                ...
                Limb = def_enum{"Head", "Torso", "LeftArm", "RightArm", "LeftLeg", "RightLeg", "Unknown"};
                ListDisplayMode = def_enum{"Horizontal", "Vertical"};
                ListenerType = def_enum{"Camera", "CFrame", "ObjectPosition", "ObjectCFrame"};
                Material = def_enum{"Plastic", "Wood", "Slate", "Concrete", "CorrodedMetal", "DiamondPlate", "Foil", "Grass", "Ice", "Marble", "Granite", "Brick", "Pebble", "Sand", "Fabric", "SmoothPlastic", "Metal", "WoodPlanks", "Cobblestone", "Air", "Water", "Rock", "Glacier", "Snow", "Sandstone", "Mud", "Basalt", "Ground", "CrackedLava", "Neon", "Glass", "Asphalt", "LeafyGrass", "Salt", "Limestone", "Pavement", "ForceField"};
                MembershipType = def_enum{"None", "BuildersClub", "TurboBuildersClub", "OutrageousBuildersClub", "Premium"};
                MeshType = def_enum{"Head", "Torso", "Wedge", "Prism", "Pyramid", "ParallelRamp", "RightAngleRamp", "CornerWedge", "Brick", "Sphere", "Cylinder", "FileMesh"};
                MessageType = def_enum{"MessageOutput", "MessageInfo", "MessageWarning", "MessageError"};
                ...
                PacketPriority = def_enum{"IMMEDIATE_PRIORITY", "HIGH_PRIORITY", "MEDIUM_PRIORITY", "LOW_PRIORITY"};
                PartType = def_enum{"Ball", "Block", "Cylinder"};
                PathStatus = def_enum{"Success", "ClosestNoPath", "ClosestOutOfRange", "FailStartNotEmpty", "FailFinishNotEmpty", "NoPath"};
                PathWaypointAction = def_enum{"Walk", "Jump"};
                PermissionLevelShown = def_enum{"Game", "RobloxGame", "RobloxScript", "Studio", "Roblox"};
                Platform = def_enum{"Windows", "OSX", "IOS", "Android", "XBoxOne", "PS4", "PS3", "XBox360", "WiiU", "NX", "Ouya", "AndroidTV", "Chromecast", "Linux", "SteamOS", "WebOS", "DOS", "BeOS", "UWP", "None"};
                PlaybackState = def_enum{"Begin", "Delayed", "Playing", "Paused", "Completed", "Cancelled"};
                PlayerActions = def_enum{"CharacterForward", "CharacterBackward", "CharacterLeft", "CharacterRight", "CharacterJump"};
                ...
                QualityLevel = def_enum{"Automatic", "Level01", "Level02", "Level03", "Level04", "Level05", "Level06", "Level07", "Level08", "Level09", "Level10", "Level11", "Level12", "Level13", "Level14", "Level15", "Level16", "Level17", "Level18", "Level19", "Level20", "Level21"};
                ...
                ReverbType = def_enum{"NoReverb", "GenericReverb", "PaddedCell", "Room", "Bathroom", "LivingRoom", "StoneRoom", "Auditorium", "ConcertHall", "Cave", "Arena", "Hangar", "CarpettedHallway", "Hallway", "StoneCorridor", "Alley", "Forest", "City", "Mountains", "Quarry", "Plain", "ParkingLot", "SewerPipe", "UnderWater"};
                RibbonTool = def_enum{"Select", "Scale", "Rotate", "Move", "Transform", "ColorPicker", "MaterialPicker", "Group", "Ungroup", "None"};
                ...
                SavedQualitySetting = def_enum{"Automatic", "QualityLevel1", "QualityLevel2", "QualityLevel3", "QualityLevel4", "QualityLevel5", "QualityLevel6", "QualityLevel7", "QualityLevel8", "QualityLevel9", "QualityLevel10"};
                ScaleType = def_enum{"Stretch", "Slice", "Tile", "Fit", "Crop"};
                ScreenOrientation = def_enum{"LandscapeLeft", "LandscapeRight", "LandscapeSensor", "Portrait", "Sensor"};
                ...
                SoundType = def_enum{"NoSound", "Boing", "Bomb", "Break", "Click", "Clock", "Slingshot", "Page", "Ping", "Snap", "Splat", "Step", "StepOn", "Swoosh", "Victory"};
                ...
                SurfaceType = def_enum{"Smooth", "Glue", "Weld", "Studs", "Inlet", "Universal", "Hinge", "Motor", "SteppingMotor", "SmoothNoOutlines"};
                ...
                TeleportResult = def_enum{"Success", "Failure", "GameNotFound", "GameEnded", "GameFull", "Unauthorized", "Flooded", "IsTeleporting"};
                TeleportState = def_enum{"RequestedFromServer", "Started", "WaitingForServer", "Failed", "InProgress"};
                TeleportType = def_enum{"ToPlace", "ToInstance", "ToReservedServer"};
                TextFilterContext = def_enum{"PublicChat", "PrivateChat"};
                TextInputType = def_enum{"Default", "NoSuggestions", "Number", "Email", "Phone", "Password"};
                ...
                TextureQueryType = def_enum{"NonHumanoid", "NonHumanoidOrphaned", "Humanoid", "HumanoidOrphaned"};
                ThreadPoolConfig = def_enum{"Auto", "PerCore1", "PerCore2", "PerCore3", "PerCore4", "Threads1", "Threads2", "Threads3", "Threads4", "Threads8", "Threads16"};
                ThrottlingPriority = def_enum{"Extreme", "ElevatedOnServer", "Default"};
                ThumbnailSize = def_enum{"Size48x48", "Size180x180", "Size420x420", "Size60x60", "Size100x100", "Size150x150", "Size352x352"};
                ...
                TouchMovementMode = def_enum{"Default", "Thumbstick", "DPad", "Thumbpad", "ClickToMove", "DynamicThumbstick"};
                ...
                UserInputType = def_enum{"MouseButton1", "MouseButton2", "MouseButton3", "MouseWheel", "MouseMovement", "Touch", "Keyboard", "Focus", "Accelerometer", "Gyro", "Gamepad1", "Gamepad2", "Gamepad3", "Gamepad4", "Gamepad5", "Gamepad6", "Gamepad7", "Gamepad8", "TextInput", "InputMethod", "None"};
                ...
                VibrationMotor = def_enum{"Large", "Small", "LeftTrigger", "RightTrigger", "LeftHand", "RightHand"};
                VideoQualitySettings = def_enum{"LowResolution", "MediumResolution", "HighResolution"};
